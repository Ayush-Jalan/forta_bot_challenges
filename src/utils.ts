...
export const DAI_TOKEN_ABI: any[] = [
...
export const MOCK_FETCHER_DATA = "320";
export const MOCK_DAI_L1_ADD = createAddress("0x123");
export const MOCK_DAI_L2_ADD = createAddress("0x456");
export const MOCK_OPT_ESCROW_ADD = createAddress("0x789");
export const MOCK_ARB_ESCROW_ADD = createAddress("0xabc");
...
export const ESCROW_BALANCES_ARR: number[] = [350, 250];
